...
use app\assets\SecondAppAsset;
use yii\helpers\Url;

AppAsset::register($this);
SecondAppAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Каталог<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="<?= Url::to(['product/index']) ?>">Продукты</a></li>
                            ...
                            <li class="dropdown"><a href="#">Блог<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    <li><a href="blog.html">Список</a></li>
                                    <li><a href="blog-single.html">Blog Single</a></li>
                                </ul>
                            </li>
<!--                            <li><a href="404.html">404</a></li>-->
                            <li><a href="contact-us.html">Обратная связь</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
